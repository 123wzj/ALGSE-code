...
#     raw_dir = "rawData/drapra3/cadets/"
#     writeSubjectFile = "ProcessedData/drapra3/cadets/test/data/subject.txt"
#     subjectID,countsubject = store_subject(raw_dir,writeSubjectFile)
#     print("reading and writing file")
#     writeFile = "ProcessedData/drapra3/cadets/test/data/file.txt"
#     fileID,countFile = store_file(raw_dir,writeFile,countsubject)
#     print("reading and writing socket")
#     writeNetFile = "ProcessedData/drapra3/cadets/test/data/socket.txt"
#     netID,countsocket = store_netflow(raw_dir,writeNetFile,countFile)
#     print("the entity num is "+str(countsocket))
#     print("creat edges")
#     writeIdtouuid = "ProcessedData/drapra3/cadets/test/data/id_to_uuid.txt"
#     entity_mapping = writeIdToUid(writeIdtouuid,subjectID,fileID,netID)
#     writeEventFile = "ProcessedData/drapra3/cadets/test/data/event.txt"
